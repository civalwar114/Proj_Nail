          ...
          <div class="filter-bar d-flex flex-wrap align-items-center">
            <div class="sorting">
              <select>
                ...
                <option  ${(param.sorting=="company")?"selected":""} value="company">배급</option>
							...
							<form action="#">
								<ul>
									<li class="filter-list"><input class="pixel-radio"
										type="radio" id="action" name="brand"><label
										for="action">액션<span></span></label></li>
									<li class="filter-list"><input class="pixel-radio"
										type="radio" id="history" name="brand"><label
										for="history">역사<span></span></label></li>
									<li class="filter-list"><input class="pixel-radio"
										type="radio" id="sports" name="brand"><label
										for="sports">스포츠<span></span></label></li>
									<li class="filter-list"><input class="pixel-radio"
										type="radio" id="comedey" name="brand"><label
										for="comedey">코미디<span></span></label></li>
									<li class="filter-list"><input class="pixel-radio"
										type="radio" id="horror" name="brand"><label
										for="horror">공포<span></span></label></li>
									<li class="filter-list"><input class="pixel-radio"
										type="radio" id="SF" name="brand"><label for="SF">SF<span></span></label></li>
								</ul>
							</form>
						</li>
					</ul>
				...
				<div class="sidebar-filter">
					...
					<div class="common-filter">
						...
						<form action="#">
							<ul>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="company1" name="brand"><label
									for="company1">회사1<span></span></label></li>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="company2" name="brand"><label
									for="company2">회사2<span></span></label></li>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="company3" name="brand"><label
									for="company3">회사3<span></span></label></li>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="company4" name="brand"><label
									for="company4">회사4<span></span></label></li>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="company5" name="brand"><label
									for="company5">회사5<span></span></label></li>
							</ul>
						</form>
					</div>
					<div class="common-filter">
						...
						<form action="#">
							<ul>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="KOR" name="country"><label for="KOR">한국<span></span></label></li>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="USA" name="country"><label for="USA">미국<span></span></label></li>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="ENG" name="country"><label for="ENG">영국<span></span></label></li>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="FRA" name="country"><label for="FRA">프랑스<span></span></label></li>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="JAP" name="country"><label for="JAP">일본<span></span></label></li>
								<li class="filter-list"><input class="pixel-radio"
									type="radio" id="HKG" name="country"><label for="HKG">홍콩<span></span></label></li>
							</ul>
						</form>
					</div>
					<div class="common-filter">
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					<div class="sorting">
						<select>
							<option ${(param.sorting=="title")?"selected":""} value="title">제목</option>
							<option ${(param.sorting=="company")?"selected":""}
								value="company">배급</option>
							<option ${(param.sorting=="country")?"selected":""}
								value="country">국가</option>
						</select>
					</div>
					<div>
						<div class="input-group filter-bar-search"></div>
						<form class="form-inline my-2 my-lg-0" action="search.movie"
							method="POST">
						...
						<c:forEach var="movie" items="${movieList}">
							<div class="col-md-6 col-lg-4">
								<div class="card text-center card-product">
									...
									<div class="card-product__img">
										<img class="card-img"
											src="<%=request.getContextPath()%>/inc/img/product/movieNum1.jpg">
										<ul class="card-product__imgOverlay">
											<li><button class="addMovieCart"
													onclick="addMovieCart(${movie.movieNum})">
									...
									<div class="card-body">
										...
										<a class="button button-blog"
											href="watchmovie.movie?num=${movie.movieNum}">바로보기</a>
									</div>
								</div>
							</div>
						</c:forEach>
				...
				<aside class="single_sidebar_widget author_widget">
					<a class="btn btn-primary" href="insert.movie" role="button">영화
						추가</a>
					<div class="br"></div>
				</aside>
...
function addMovieCart(movieNum) {
	/* console.log(a); */
	$.ajax({
		url: "<%=request.getContextPath()%>/cart/cartMovieInsert.cart",
		type : "POST",
		data : {
			movieNum : movieNum
		},
